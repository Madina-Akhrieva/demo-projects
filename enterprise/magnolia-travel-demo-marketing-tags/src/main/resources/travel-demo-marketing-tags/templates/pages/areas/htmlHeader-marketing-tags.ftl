...
[#if root.cookieConsentName?has_content]
    [#assign configContent = cmsfn.contentById("/modules/cookie-manager/config/cookies/cookieConsentDenied", "config")]
    [#assign cookieConsentName = configContent.name!"cookieconsent_status"]
[/#if]
