...
/**
 * Model for displaying a tour and its related tours by type- and destination-category.
 */
public class TourDetailModel extends RenderingModelImpl<TemplateDefinition> {
